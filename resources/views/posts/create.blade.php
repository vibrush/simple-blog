...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white border border-slate-150 rounded-2xl p-6 sm:p-8 shadow-sm">
        <div class="border-b border-slate-100 pb-5 mb-6">
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Tulis Artikel Baru</h1>
            <p class="mt-1.5 text-sm text-slate-500">Bagikan ide, wawasan, atau tutorial menarik Anda dengan komunitas developer.</p>
        </div>
        ...
        <form action="/posts" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" required placeholder="Masukkan judul yang menarik..." 
            ...
            <div>
                ...
                <textarea name="content" id="content" required rows="10" placeholder="Tuliskan isi artikel Anda secara lengkap di sini..." 
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                <a href="/" class="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
                    Batal
                </a>
